<span data-ttu-id="ff940-101">[使用管理 API 來設定 Azure SQL Database][1] </span><span class="sxs-lookup"><span data-stu-id="ff940-101">[Configure Azure SQL Database with the management API][1] </span></span>  
