...
---
# <a name="whats-new-in-the-azure-toolkit-for-eclipse"></a><span data-ttu-id="9eaff-103">適用於 Eclipse 的 Azure 工具組的新功能</span><span class="sxs-lookup"><span data-stu-id="9eaff-103">What's new in the Azure Toolkit for Eclipse</span></span>

<span data-ttu-id="9eaff-104">以下網頁包含適用於 Eclipse 的 Azure 工具組的各種版本和最新更新相關資訊。</span><span class="sxs-lookup"><span data-stu-id="9eaff-104">The following web page contains information on the various releases and latest updates to the Azure Toolkit for Eclipse.</span></span>

<https://github.com/Microsoft/azure-tools-for-java/releases>

> [!NOTE] 
> <span data-ttu-id="9eaff-105">另外還有適用於 IntelliJ IDE 的 Azure 工具組。</span><span class="sxs-lookup"><span data-stu-id="9eaff-105">There is also an Azure Toolkit for the IntelliJ IDE.</span></span> <span data-ttu-id="9eaff-106">如需詳細資訊，請參閱 [Azure Toolkit for IntelliJ]。</span><span class="sxs-lookup"><span data-stu-id="9eaff-106">For more information, see [Azure Toolkit for IntelliJ].</span></span> 
> 
...
## <a name="next-steps"></a><span data-ttu-id="9eaff-107">後續步驟</span><span class="sxs-lookup"><span data-stu-id="9eaff-107">Next steps</span></span>
